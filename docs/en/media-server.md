...
- Browse movies, shows, and recently watched items in the poster wall.
- Search the whole library and choose an episode directly from a series.
- Start playback, pause, seek, and switch subtitle or audio tracks from your phone.

Playback still happens on the computer connected to the TV. The media server organises the content; TinyPlay provides the phone-friendly control interface and TV playback.
