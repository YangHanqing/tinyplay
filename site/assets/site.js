(function () {
  ...
  messages[ZH] = {
    ...
    nav_download: '下载',
    hero_eyebrow: '为家里的闲置性能找一块屏幕',
    hero_title: '下载机，不只下载。<br><em>接上 HDMI，它也能管客厅。</em>',
    hero_lead: '让已经在跑 Docker、下载任务和家庭服务的 N100、NUC、迷你主机或 Mac mini，再兼任一台强大的电视播放器。TinyPlay 把手机变成遥控器，电脑负责播放，你不必再从沙发上找鼠标。',
    btn_download_app: '下载 macOS/Win App <span>↗</span>',
    ...
    why1_title: '性能已经在那里了',
    why1_body: '很多人的 N100、NUC 或迷你主机，本来就在做下载机、跑 Docker、管理 NAS。它功耗不高、长期在线，还有一个经常闲着的 HDMI 接口。没必要再买一台只能做一件事的设备。',
    why2_title: '但"能播放"不等于"好控制"',
    why2_body: '电脑接上电视很简单，真正麻烦的是窝在沙发里选片、拖进度、切字幕：键盘鼠标不属于客厅，远程桌面又太重。',
    why3_title: '于是有了 TinyPlay',
    why3_body: '桌面端连接 Emby、Jellyfin、Plex 或 SMB/WebDAV 共享并驱动 mpv，手机扫描二维码后就能浏览媒体库和控制播放。播放留在小主机，控制回到你手里。',
    features_title: '电脑负责兼容性，<br>手机负责顺手。',
    features_lead: 'mpv 负责真正的播放，TinyPlay 负责把媒体库、遥控器和桌面播放器连在一起。没有云端中转，操作都发生在你的家庭局域网里。',
    ...
    v3_tag: '最全能',
    v3_title: 'Apple Silicon Mac mini',
    ...
    safety_title: '只在可信局域网内使用',
    safety_body: 'TinyPlay 的手机遥控页面没有独立登录验证。请勿将其监听端口暴露到公网；手机与播放器电脑应连接同一个可信家庭网络。',
  ...
  messages[EN] = {
    ...
    hero_eyebrow: 'A screen for the idle power already in your home',
    hero_title: 'It already downloads things.<br><em>Plug in HDMI, and it runs the living room too.</em>',
    hero_lead: 'That N100, NUC, mini PC, or Mac mini already running Docker, downloads, and home services can also be a serious TV player. TinyPlay turns your phone into the remote; the computer does the playback. No more hunting for a mouse on the couch.',
    btn_download_app: 'Download macOS/Win App <span>↗</span>',
    ...
    why1_body: 'Plenty of N100s, NUCs, and mini PCs are already downloading, running Docker, and managing a NAS. Low power draw, always on, and usually an idle HDMI port. No need to buy another single-purpose box.',
    ...
    why3_body: 'The desktop app connects to Emby, Jellyfin, Plex, or an SMB/WebDAV share and drives mpv; your phone scans a QR code and browses the library and controls playback. Playback stays on the mini PC, control comes back to your hand.',
    features_title: 'The computer handles compatibility,<br>the phone handles convenience.',
    features_lead: 'mpv handles the actual playback; TinyPlay connects your media library, remote, and desktop player together. No cloud relay — everything happens on your home LAN.',
    ...
    t_col_mac: 'Apple Silicon Mac mini',
    t_col_atv: 'Apple TV 4K',
    ...
    download_platforms: 'Windows x86-64 · macOS Apple Silicon',
    safety_title: 'Use only on a trusted LAN',
    safety_body: 'TinyPlay’s phone remote page has no separate login. Don’t expose its listening port to the public internet; your phone and the player computer should be on the same trusted home network.',
    footer_tagline: 'Turn the little box into the big screen.',
    footer_license: 'MIT License',
