(function () {
  ...
  messages[ZH] = {
    ...
    feature6_title: 'DLNA 投屏接收',
    feature6_body: '让同一局域网内支持 DLNA 的应用发现 TinyPlay；投屏会直接在电脑上播放，手机遥控器可继续暂停、播放和跳转。',
  ...
  messages[EN] = {
    ...
    feature6_title: 'DLNA cast receiver',
    feature6_body: 'Let DLNA-capable apps on your LAN discover TinyPlay. Cast playback opens directly on the computer, while the phone remote keeps play, pause, and seek.',
